...
{    internal class Program{
        ...
        static void Main(string[] args){
            ...
            for (int z = 1; z < value+1; z++){
                if (z < 10)
                    path = "C:\\Users\\ziabr\\Downloads\\deeznuts\\deeznuts\\input_s1_0" + Convert.ToString(z) + ".txt";
                else
                    path = "C:\\Users\\ziabr\\Downloads\\deeznuts\\deeznuts\\input_s1_" + Convert.ToString(z) + ".txt";
                ...
                foreach (int[] i in apples_copy) //удаление ненужных яблок{
                    if (i[1] < itsok)
                        apples.Remove(i);
                ...
                if (z < 10)
                    path = "C:\\Users\\ziabr\\Downloads\\deeznuts\\deeznuts\\output_s1_0" + Convert.ToString(z) + ".txt";
                else
                    path = "C:\\Users\\ziabr\\Downloads\\deeznuts\\deeznuts\\output_s1_" + Convert.ToString(z) + ".txt";
                using (StreamReader reader = new StreamReader(path)){
                    string? line;
                    line = reader.ReadLine();
                    if (int.Parse(line) == distance)
                        Console.WriteLine("{0} - ок", z);
                    else
                        Console.WriteLine("{0} - не ок", z);
                }
